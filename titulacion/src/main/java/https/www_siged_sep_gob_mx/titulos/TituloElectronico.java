...
package https.www_siged_sep_gob_mx.titulos;
    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        protected List<TituloElectronico.FirmaResponsables.FirmaResponsable> firmaResponsables;
         ...
         * This is why there is not a <CODE>set</CODE> method for the firmaResponsables property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getFirmaResponsables().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<TituloElectronico.FirmaResponsables.FirmaResponsable> getFirmaResponsables() {
            if (firmaResponsables == null) {
                firmaResponsables = new ArrayList<TituloElectronico.FirmaResponsables.FirmaResponsable>();
            }
            return this.firmaResponsables;
        }
